...
public class ViewController {
    ...
    private void loadHome() throws IOException {
        Node view = FXMLLoader.load(getClass().getResource("/ood/application/moneykeeper/home.fxml"));
        mainPane.setCenter(view);
    }

    @FXML
    private void loadStats() throws IOException {
        Node view = FXMLLoader.load(getClass().getResource("/ood/application/moneykeeper/stats.fxml"));
        mainPane.setCenter(view);
    }
    ...
    @FXML
    private void openTransactionWindow() throws IOException {
        Node view = FXMLLoader.load(getClass().getResource("/ood/application/moneykeeper/add_trans.fxml"));
        mainPane.setCenter(view);
//        try {
